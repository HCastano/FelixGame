...
public class AtlanticScoresPanel extends SubMenu
{
  JLabel[] countLabels;
  JLabel[] nameLabels;
  JLabel[] minsLabels;
  ...
  public AtlanticScoresPanel ()
  {
    super ("atlanticscoresbackground", false);
    drawScores ();
  }
  ...
  public void drawScores ()
  {
    ...
    int[] mins = new int [10];
    int[] secs = new int [10];
    AtlanticPlayer[] players = hs.getAtlanticPlayers ();
